    ...
    for i, (keyword, result) in enumerate(results.items()):
        for j in range(0, len(result[0])):
                ...
                if stopword == 0:
                    try:
                        print(zahl)
                        worksheet.write('A{}'.format(zahl),
                                        result[7][j])  # screen id
                        worksheet.write('B{}'.format(zahl),
                                        result[8][j])  # rank
                        worksheet.write('C{}'.format(zahl),
                                        result[6])  # datum uhrzeit
                        worksheet.write('D{}'.format(zahl),
                                        keyword)  # datum uhrzeit
                        worksheet.write('E{}'.format(zahl),
                                        result[0][j])  # google result
                        worksheet.write('F{}'.format(zahl),
                                        result[1][j])  # google result
                        worksheet.write('G{}'.format(zahl),
                                        result[2][j])  # google result
                        worksheet.write('H{}'.format(zahl),
                                        result[3][j])  # google result
                        # google ident result
                        worksheet.write('J{}'.format(zahl), result[5][j])
                        # Von Google / ..
                        worksheet.write('I{}'.format(zahl), result[4][j])
